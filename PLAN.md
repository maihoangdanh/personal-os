...
2. Backup Service cho VM/Docker — **quyết định không làm** (người dùng xác nhận 2026-07-22), rủi ro
   thấp vì dữ liệu chính ở Supabase đã có backup riêng.
3. Dùng thật hàng ngày để tinh chỉnh ngưỡng Eisenhower + phát hiện thêm bug ẩn (đã có 4 ca thật —
