...
Cập nhật lần cuối: 2026-07-18 (rà soát toàn bộ theo trạng thái code thật — 101/101 unit test pass,
typecheck backend+frontend sạch, 15 migration, 21 module backend). Theo dõi tiến độ từ
...
- [ ] ❌ Deploy VPS (Docker + Nginx) — **chủ đích để cuối cùng**, sau khi dùng ổn định ở local (theo đúng yêu cầu ban đầu)
